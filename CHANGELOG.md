...
- Certify pm CLI 2026.9.23 and adopt the guarded pm-ops merge-driver launcher ([pm-linear-kdum](https://github.com/unbraind/pm-linear/blob/main/.agents/pm/chores/pm-linear-kdum.toon))

## 2026.9.22 - 2026-09-22

### Fixed

- A publish that npm accepts late is reported as failed and the GitHub Release is skipped on bun mirror lag ([pm-linear-seq7](https://github.com/unbraind/pm-linear/blob/main/.agents/pm/issues/pm-linear-seq7.toon))

### Other

- Certify pm CLI 2026.9.21 and install merge drivers through the canonical pm-ops launcher ([pm-linear-em7w](https://github.com/unbraind/pm-linear/blob/main/.agents/pm/tasks/pm-linear-em7w.toon))
...
- Certify pm CLI 2026.9.12 and the pm-ops 2026.9.11 auditor ([pm-linear-hq5i](https://github.com/unbraind/pm-linear/blob/main/.agents/pm/chores/pm-linear-hq5i.toon))
...
- Harden the attestation consumer suite to match the rest of the converged fleet ([pm-linear-ku56](https://github.com/unbraind/pm-linear/blob/main/.agents/pm/chores/pm-linear-ku56.toon))
